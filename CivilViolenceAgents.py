...
class PopulationAgent(Agent):
    ...
    '''
    def __init__(self, unique_id, model, hardship, legitimacy, risk_aversion, threshold, vision, pos):
        '''
    ...
    def step(self):
        # The population agent's movement and activenes rules A and M from the paper
        ...
        # a rounding to min integer is implemented as suggested in the netlogo implementation
...
class CopAgent(Agent):
    ...
    def step(self):
        ...
        # arrest a random active agent and jail her for a random choice of up to JAIL_MAX_TERM steps
        if actives:
