...
model_params = {
    ...
    "propaganda_exposure_threshold": UserSettableParameter("slider", "Propaganda Exposure Threshold",100, 0, 10000,
        description="How many propaganda exposures before induced nationalism?"),
